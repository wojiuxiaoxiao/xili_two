...
/* jinxuan */
define('APPKEY','gr7PpFFaCH9sayzyS77279');
define('APPID','8ywCgcu0dV8zNgH7OhlZe');
define('MASTERSECRET','PW6QHKoSN864csCf3HWRd5');
define('CID','c558e8078e2c588948aa78acba6306bc');

/* my test */
//define('APPKEY','nV2S9djKfBAnMlyylxBU44');
//define('APPID','tenwP1Pmqs9ZtBAkJOXWw6');
//define('MASTERSECRET','t0UYHibbkV60pmYJRfYWtA');
//define('CID','796b7a3b5ece54b48b0ac19b0e843a68');
...
function IGtTransmissionTemplateDemo(){
    ...
    $template->set_appkey(APPKEY);//应用appkey
    $template->set_transmissionType(1);//透传消息类型
    $template->set_transmissionContent("测试离线bixudi");//透传内容
    //$template->set_duration(BEGINTIME,ENDTIME); //设置ANDROID客户端在此时间区间内展示消息
    //APN简单推送
