...
class MessageController extends Controller
{
    ...
    public function programMessage(){
        ...
        $comment_list = Comment::whereIn('pid', Comment::where([['comment.user_id','=',USERID]])->pluck('id'))
            ->select('user.id as user_id','user.avatar','user.nickname','comment.id','comment.create_time','comment.rootid','comment.content','comment.pid','comment.program_id','comment.type')
            ->leftJoin('user', 'user.id', '=', 'comment.user_id')
            ->orderBy('create_time', 'desc')
            ->get()->toArray();
    ...
    public function articleMessage(){
        ...
        $comment_list = CommentArticle::whereIn('pid', CommentArticle::where([['comment_article.user_id','=',USERID]])->pluck('id'))
            ->select('user.id as user_id','user.avatar','user.nickname','comment_article.id','comment_article.create_time','comment_article.rootid','comment_article.content','comment_article.pid','comment_article.article_id','comment_article.type')
...
//            ->limit($pagesize)
    ...
    public function answerReplys(){
        ...
        $comment_list = CommentInterlocution::whereIn('pid', CommentInterlocution::where([['comment_interlocution.user_id','=',USERID]])->pluck('id'))
            ...
            ->select('user.id as user_id','user.avatar','user.nickname','comment_interlocution.pid','comment_interlocution.interlocut_id','comment_interlocution.id','comment_interlocution.create_time','comment_interlocution.rootid','comment_interlocution.content','comment_interlocution.type')
    ...
    public function answerTopic(){
        ...
        $comment_list = CommentInterlocution::whereIn('interlocut_id', Interlocution::where([['interlocution.user_id','=',USERID]])->pluck('id'))
            ->where('comment_interlocution.rootid','=',0)
            ->select('user.id as user_id','user.avatar','user.nickname','comment_interlocution.interlocut_id','comment_interlocution.id','comment_interlocution.create_time','comment_interlocution.rootid','comment_interlocution.content','comment_interlocution.type')
            ->leftJoin('user', 'user.id', '=', 'comment_interlocution.user_id')
            ->orderBy('comment_interlocution.create_time', 'desc')
            ->offset($start)
            ->limit($pagesize)
