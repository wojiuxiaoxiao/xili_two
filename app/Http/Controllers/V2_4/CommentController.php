...
use App\Http\Provider\V2_4\CommentService;
        ...
        switch ($type)//1 活动 2 文章 3 节目
        {
            case 1:
                $pcomment_list = CommentActive::where([['comment_active.active_id','=',$multi_id],['comment_active.rootid','=',0],['comment_active.status','=',1],['user.status','=',1]])
                    ->select('comment_active.content','comment_active.create_time','comment_active.type','comment_active.id','comment_active.likes','comment_active.user_id','comment_active.active_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
            ...
            case 2:
                $pcomment_list = CommentArticle::where([['comment_article.article_id','=',$multi_id],['comment_article.rootid','=',0],['comment_article.status','=',1],['user.status','=',1]])
                    ->select('comment_article.content','comment_article.create_time','comment_article.type','comment_article.id','comment_article.likes','comment_article.user_id','comment_article.article_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
            ...
            case 3:
                $pcomment_list = Comment::where([['comment.program_id','=',$multi_id],['comment.rootid','=',0],['comment.status','=',1],['user.status','=',1]])
                    ->select('comment.content','comment.create_time','comment.type','comment.id','comment.user_id','comment.likes','comment.program_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
        ...
        switch ($type)//1 活动 2 文章 3节目
        {
            case 1:
                $comment = CommentActive::where([['comment_active.id','=',$pmulti_id],['comment_active.rootid','=',0],['comment_active.status','=',1]])
                    ->select('comment_active.content','comment_active.create_time','comment_active.id','comment_active.type','comment_active.likes','comment_active.user_id','comment_active.active_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
                    ->leftJoin('user', 'comment_active.user_id', '=', 'user.id')
                    ->first();
                ...
                $comment_children = CommentActive::where([['comment_active.rootid','=',$pmulti_id],['comment_active.status','=',1]])
                    ->select('comment_active.content','comment_active.pid','comment_active.create_time','comment_active.id','comment_active.type','comment_active.likes','comment_active.user_id','comment_active.active_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
                    ->leftJoin('user', 'comment_active.user_id', '=', 'user.id')
                    ->offset($start)
                    ->limit($pagesize)
                    ->orderBy('create_time', 'desc')
            ...
            case 2:
                ...
                $comment = CommentArticle::where([['comment_article.id','=',$pmulti_id],['comment_article.rootid','=',0],['comment_article.status','=',1]])
                    ->select('comment_article.content','comment_article.create_time','comment_article.id','comment_article.type','comment_article.likes','comment_article.user_id','comment_article.article_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
                    ->leftJoin('user', 'comment_article.user_id', '=', 'user.id')
                    ->first();
                $comment['canDel'] = ($comment['user_id']==$userid) ? 1 : 0;
                ...
                $comment_children = CommentArticle::where([['comment_article.rootid','=',$pmulti_id],['comment_article.status','=',1]])
                    ->select('comment_article.content','comment_article.pid','comment_article.create_time','comment_article.id','comment_article.type','comment_article.user_id','comment_article.likes','comment_article.article_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
                    ->leftJoin('user', 'comment_article.user_id', '=', 'user.id')
                    ->offset($start)
                    ->limit($pagesize)
                    ->orderBy('create_time', 'desc')
            ...
            case 3:
                $comment = Comment::where([['comment.id','=',$pmulti_id],['comment.rootid','=',0],['comment.status','=',1]])
                    ->select('comment.content','comment.create_time','comment.id','comment.type','comment.user_id','comment.rootid','comment.likes','comment.program_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
                    ->leftJoin('user', 'comment.user_id', '=', 'user.id')
                    ->first();
                $comment['canDel'] = ($comment['user_id']==$userid) ? 1 : 0;
                ...
                $comment_children = Comment::where([['comment.rootid','=',$pmulti_id],['comment.status','=',1]])
                    ->select('comment.content','comment.pid','comment.create_time','comment.id','comment.user_id','comment.type','comment.rootid','comment.likes','comment.program_id as multi_id','user.avatar','user.nickname', 'user.type as user_type')
                    ->leftJoin('user', 'comment.user_id', '=', 'user.id')
                    ->offset($start)
                    ->limit($pagesize)
                    ->orderBy('create_time', 'desc')
