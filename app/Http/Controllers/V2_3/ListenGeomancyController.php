...
class ListenGeomancyController extends Controller
{
    ...
    public function masterList(){
        ...
        $returnList = User::where($where)
            ...
            ->select('user.nickname','column.title','signed_author.background_pic','program.author_id')
    ...
    public function playRadio(){
        ...
        $program_info = Program::where($where)
            ->select('id', 'radio_pic', 'radio_url', 'name', 'showup_time', 'burning_time', 'play_nums', 'column_name', 'audio_s_introduce', 'audio_introduce', 'status as del_status', 'type')
            ->first();
